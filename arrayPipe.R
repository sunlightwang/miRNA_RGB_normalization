...
# ### for array split 
# keys <- c("A019","A032","A035","A081")
# dir <- "array_split/"
# ### for array_comb_2
# keys <- c("A019A032","A019A035","A019A081","A032A035","A032A081","A035A081")
# dir <- "array_comb_2/"
# ### for array_comb_3 
# keys <- c("A019A032A035","A019A032A081","A019A035A081","A032A035A081")
# dir <- "array_comb_3/"
...
for(key in keys) {
  ...
  arrayAnalysis(dataFile=dataFile, sampleInfoFile=sampleInfoFile, controlDataFile=controlDataFile, labels=labels, outFilePrefix=outFilePrefix, comBat=TRUE)
}
