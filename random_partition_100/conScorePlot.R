...
setwd("~/Projects/bioMarker/PBMCFromRawData/random_partition_100/")
# limma
mean <- read.table("conscore.limma.mean")
se <- read.table("conscore.limma.se")
consist_score_errorbar_barplot(mean, se, main="limma without Combat")
# ftest
mean <- read.table("conscore.ftest.mean")
se <- read.table("conscore.ftest.se")
consist_score_errorbar_barplot(mean, se, main="F-test without Combat")
# samr
mean <- read.table("conscore.samr.mean")
se <- read.table("conscore.samr.se")
consist_score_errorbar_barplot(mean, se, main="SAM without Combat")

##### combat #####
# limma
mean <- read.table("conscore.combat.limma.mean")
se <- read.table("conscore.combat.limma.se")
consist_score_errorbar_barplot(mean, se, main="limma with Combat")
# ftest
mean <- read.table("conscore.combat.ftest.mean")
se <- read.table("conscore.combat.ftest.se")
consist_score_errorbar_barplot(mean, se, main="F-test with Combat")
# samr
mean <- read.table("conscore.combat.samr.mean")
se <- read.table("conscore.combat.samr.se")
